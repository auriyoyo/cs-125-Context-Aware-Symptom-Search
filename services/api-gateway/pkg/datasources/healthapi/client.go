...
func (c *Client) Query(query string) (map[string]interface{}, error) {
	url := fmt.Sprintf("%s/query?q=%s", c.baseURL, query)
...
func (c *Client) QueryWithRequest(req *QueryRequest) (interface{}, error) {
	params := url.Values{}
	if len(req.Terms) > 0 {
...
func (c *Client) PostQuery(endpoint string, payload interface{}) (map[string]interface{}, error) {
